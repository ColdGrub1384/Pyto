...
if __platform__ is macOS:
    raise ImportError("Cannot import mainthread on macOS. On macOS, scripts are ran in the main thread of a subprocess. To check for platform, see the `__platform__` global variable.")
