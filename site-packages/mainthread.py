...
if __platform__ is macOS:
    raise ImportError("Cannot import mainthread on macOS. On macOS, scripts are executed in the main thread of a subprocess. This module is required to show UI on iOS app because scripts are executed on a background thread of the Pyto app. To check for platform, see the __platform__ global variable.")
