...
def runScriptAtPath(path):
    ...
    def run() -> None:
        ...
        try:
            ...
            formattedTraceback = traceback.format_exc(limit=-count)
            
            PytoClasses.ErrorViewController.presentErrorWithReason(str(e), type=exc_type.__name__, traceback=formattedTraceback)
