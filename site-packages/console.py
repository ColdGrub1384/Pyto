...
if __host__ is not widget:
    ...
    class Alert:
        """
        A wrapper of `PyAlert` Objective-C class that represents an UI alert.
        """
        ...
        def __init__(self):
            ...
            if __platform__ is not iOS:
                raise NotImplementedError("Alert is only supported on iOS. To check for platform, see the `__platform__` global variable.")
        ...
        def addCancelAction(self, title):
            """
            Add a cancel action with given title.
                
            Args:
                title: The title of the alert.
            """
            
            self.pyAlert.addCancelAction(title)
