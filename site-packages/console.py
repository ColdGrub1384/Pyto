...
'''threads = {}
"""
Threads running scripts. Keys: Scripts path, values: threads.
"""'''
...
def print(*objects, sep=None, end=None):
    ...
    try:
        PyOutputHelper.print(sep.join(array)+end, script=threading.current_thread().script_path)
    except:
        PyOutputHelper.print(sep.join(array)+end, script=None)
