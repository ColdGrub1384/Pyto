...
from stash.stashutils.extensions import create_command
from stash.stashutils.wheels import Wheel, wheel_is_compatible

import wget

import stash.libversion as libversion

if __platform__ is macOS:
    raise ImportError('Cannot use StaSh pip on macOS. Use original pip.')
...
BUNDLED_MODULES = ['certifi', 'chardet', 'colorama', 'cycler', 'dateutil', 'distlib', 'idna', 'ipaddress', 'jedi', 'lockfile', 'matplotlib', 'numpy', 'pandas', 'setuptools', 'progress', 'pyparsing', 'pytoml', 'pytz', 'queue', 'requests', 'rubicon', 'six', 'stopit', 'urllib3', 'webencodings', 'wsgiref', 'black', 'attr', 'toml', 'entrypoints', 'xlrd', 'bs4', 'beautifulsoup4', 'soupsieve', 'parso']
