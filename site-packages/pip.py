...
BUNDLED_MODULES = ['certifi', 'chardet', 'colorama', 'cycler', 'python-dateutil', 'distlib', 'idna', 'ipaddress', 'jedi', 'filelock', 'matplotlib', 'numpy', 'pandas', 'setuptools', 'progress', 'pyparsing', 'pytoml', 'pytz', 'queue', 'requests', 'rubicon', 'rubicon-objc', 'six', 'stopit', 'urllib3', 'webencodings', 'wsgiref', 'black', 'attr', 'toml', 'entrypoints', 'xlrd', 'bs4', 'beautifulsoup4', 'soupsieve', 'parso', 'PIL', 'Pillow', 'pillow', 'biopython', 'lxml', 'scipy', 'scikit-learn', 'sklearn', 'scikit-image', 'skimage', 'networkx', 'pywt', 'joblib', 'dask', 'cloudpickle', 'imageio', 'opencv-python', 'cffi', 'decorator', 'PyNaCl', 'pynacl', 'pip', 'kiwisolver', 'cryptography', 'asn1crypto', 'bcrypt']
