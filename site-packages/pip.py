...
if False:
    ...
    BUNDLED_MODULES = ['certifi', 'chardet', 'colorama', 'cycler', 'dateutil', 'distlib', 'idna', 'ipaddress', 'jedi', 'lockfile', 'matplotlib', 'numpy', 'pandas', 'setuptools', 'progress', 'pyparsing', 'pytoml', 'pytz', 'queue', 'requests', 'rubicon', 'six', 'stopit', 'urllib3', 'webencodings', 'wsgiref']
