...
# [omz] This change is necessary because Pythonista doesn't come with pkg_resources; the effect is the same.
#_TRUSTED_CERT_FILE = pkg_resources.resource_filename(__name__, 'trusted-certs.crt')
import os
_TRUSTED_CERT_FILE = os.path.join(os.path.split(__file__)[0], 'trusted-certs.crt')
