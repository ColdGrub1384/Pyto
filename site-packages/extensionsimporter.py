...
class StatsmodelsImporter(object):
    ...
    def find_module(self, fullname, mpath=None):
        ...
        if fullname in ('statsmodels.tsa.statespace._smoothers._alternative', 'statsmodels.tsa.innovations._arma_innovations', 'statsmodels.tsa.statespace._smoothers._classical', 'statsmodels.tsa._exponential_smoothers', 'statsmodels.tsa.statespace._filters._filters__conventional', 'statsmodels.tsa.statespace._filters._filters__univariate_diffuse', 'statsmodels.tsa.statespace._filters._filters__univariate', 'statsmodels.tsa.regime_switching._hamilton_filter', 'statsmodels.tsa.statespace._initialization', 'statsmodels.tsa._innovations', 'statsmodels.tsa.statespace._filters._inversions', 'statsmodels.tsa.statespace._kalman_filter', 'statsmodels.tsa.statespace._kalman_smoother', 'statsmodels.tsa.regime_switching._kim_smoother', 'statsmodels.tsa.statespace._representation', 'statsmodels.tsa.statespace._simulation_smoother', 'statsmodels.tsa.statespace._smoothers._smoothers__conventional', 'statsmodels.tsa.statespace._smoothers._smoothers__univariate_diffuse', 'statsmodels.tsa.statespace._smoothers._smoothers__univariate', 'statsmodels.nonparametric._smoothers_lowess', 'statsmodels.tsa._stl', 'statsmodels.tsa.statespace._tools', 'statsmodels.tsa.kalmanf.kalman_loglike', 'statsmodels.nonparametric.linbin',):
            return self
            ...
            def importMod():
                with warnings.catch_warnings(record=True) as w:
                    ...
                    try:
                        ...
                        mod = importlib.__import__(f.replace('_smoothers.', '_smoothers._smoothers.').replace('_filters.', '_filters._filters.'))
...
__all__ = ['NumpyImporter', 'MatplotlibImporter', 'PandasImporter', 'PillowImporter', 'BiopythonImporter', 'LXMLImporter', 'ScipyImporter', 'SkLearnImporter', 'SkImageImporter', 'PywtImporter', 'NaclImporter', 'CryptographyImporter', 'BcryptImporter', 'StatsmodelsImporter']
