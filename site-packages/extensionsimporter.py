...
class MatplotlibImporter(object):
    ...
    def find_module(self, fullname, mpath=None):
        if fullname in ('matplotlib.backends._backend_agg', 'matplotlib._path', 'matplotlib._image', 'matplotlib._png', 'matplotlib.ft2font', 'matplotlib._contour', 'matplotlib._qhull', 'matplotlib._tri'):
            return self
...
__all__ = ['NumpyImporter', 'MatplotlibImporter', 'PandasImporter', 'PillowImporter', 'BiopythonImporter', 'LXMLImporter', 'ScipyImporter', 'SkLearnImporter', 'SkImageImporter', 'PywtImporter', 'NaclImporter', 'CryptographyImporter', 'BcryptImporter']
