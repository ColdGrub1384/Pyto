...
def report_error(module, trace_back, e):
    ...
    try:
        ...
        alert = Alert.alert(title=module, message="An error occurred while importing "+module+".\n\nDo you want to report error to the developer?")
        ...
        if mod is None:
            ...
            if fullname != 'PIL':
                ...
                try:
                    ...
                    print(e)
                    report_error('Pillow', traceback.format_exc())
                    raise
                finally:
                    self.__is_importing__ = False
        ...
        if mod is None:
            ...
            if fullname != 'Bio' or __host__ is widget:
                ...
                try:
                    ...
                    print(e)
                    report_error('Biopython', traceback.format_exc())
                    raise
                finally:
                    self.__is_importing__ = False
...
__all__ = ['NumpyImporter', 'MatplotlibImporter', 'PandasImporter', 'PillowImporter', 'BiopythonImporter']
