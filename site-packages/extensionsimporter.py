...
class SkLearnImporter(object):
    ...
    def find_module(self, fullname, mpath=None):
        if fullname in ('sklearn.tree._tree', 'sklearn.tree._criterion', 'sklearn.tree._splitter', 'sklearn.tree._utils', 'sklearn.metrics.cluster.expected_mutual_info_fast', 'sklearn.metrics.pairwise_fast', 'sklearn.ensemble._gradient_boosting', 'sklearn.cluster._k_means', 'sklearn.cluster._hierarchical', 'sklearn.cluster._dbscan_inner', 'sklearn.cluster._k_means_elkan', 'sklearn.feature_extraction._hashing', 'sklearn.__check_build._check_build', 'sklearn.datasets._svmlight_format', 'sklearn.linear_model.sgd_fast', 'sklearn.linear_model.sag_fast', 'sklearn.linear_model.cd_fast', 'sklearn.utils.arrayfuncs', 'sklearn.utils.graph_shortest_path', 'sklearn.utils.murmurhash', 'sklearn.utils.sparsefuncs_fast', 'sklearn.utils.fast_dict', 'sklearn.utils.weight_vector', 'sklearn.utils._logistic_sigmoid', 'sklearn.utils.seq_dataset', 'sklearn.utils.lgamma', 'sklearn.utils._random', 'sklearn.utils._cython_blas', 'sklearn._isotonic', 'sklearn.svm.libsvm', 'sklearn.svm.liblinear', 'sklearn.svm.libsvm_sparse', 'sklearn.manifold._barnes_hut_tsne', 'sklearn.manifold._utils', 'sklearn.decomposition.cdnmf_fast', 'sklearn.decomposition._online_lda', 'sklearn.neighbors.quad_tree', 'sklearn.neighbors.typedefs', 'sklearn.neighbors.ball_tree', 'sklearn.neighbors.dist_metrics', 'sklearn.neighbors.kd_tree', 'sklearn.preprocessing._csr_polynomial_expansion', 'sklearn.ensemble._hist_gradient_boosting.types', 'sklearn.ensemble._hist_gradient_boosting._gradient_boosting'):
            return self
...
class OpenCvImporter(object):
    """
    Meta path for importing OpenCV to be added to `sys.meta_path`.
    """
    ...
    def find_module(self, fullname, mpath=None):
        ...
        if fullname == 'cv2' and not self.__is_importing__:
            return self
        
        if fullname in ('cv2.cv2', 'cv2.cv2'):
            return self
        ...
        if mod is None:
            ...
            if fullname != 'cv2' :
                ...
                try:
                    ...
                    print(e)
                    report_error('OpenCV', traceback.format_exc(), e)
                    raise
                finally:
                    self.__is_importing__ = False
...
__all__ = ['NumpyImporter', 'MatplotlibImporter', 'PandasImporter', 'PillowImporter', 'BiopythonImporter', 'LXMLImporter', 'ScipyImporter', 'SkLearnImporter', 'SkImageImporter', 'PywtImporter', 'OpenCvImporter']
