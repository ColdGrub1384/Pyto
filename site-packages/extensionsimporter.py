        ...
        if mod is None:
            ...
            if fullname != 'sklearn':
                ...
                try:
                    ...
                    print(e)
                    report_error('Sklearn', traceback.format_exc(), e)
                    raise
                finally:
                    self.__is_importing__ = False
...
__all__ = ['NumpyImporter', 'MatplotlibImporter', 'PandasImporter', 'PillowImporter', 'BiopythonImporter', 'LXMLImporter', 'ScipyImporter', 'SklearnImporter']
