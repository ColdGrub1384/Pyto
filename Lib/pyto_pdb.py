...
"""
(Modified version by Pyto with UI support and so `main` accepts custom arguments)
...
import console
import weakref
from _exc_handling import NamespaceHolder
...
def main(argv=sys.argv):
    ...
    opts, args = getopt.getopt(argv[1:], "mhc:", ["--help", "--command="])
    ...
    argv[:] = args  # Hide "pdb.py" and pdb options from argument list
