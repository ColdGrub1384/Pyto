...
ICDocCamThumbnailZoomTransitionAnimator = _Class('ICDocCamThumbnailZoomTransitionAnimator')
...
DCDocumentInfoCollectionActivityItemSource = _Class('DCDocumentInfoCollectionActivityItemSource')
...
DCDocumentCameraViewServiceSessionRequest = _Class('DCDocumentCameraViewServiceSessionRequest')
...
ICDocCamReorderingThumbnailCollectionViewLayout = _Class('ICDocCamReorderingThumbnailCollectionViewLayout')
DCMarkupActivity = _Class('DCMarkupActivity')
ICDocCamPhysicalCaptureRecognizer = _Class('ICDocCamPhysicalCaptureRecognizer')
ICDocCamImageQuadEditPanGestureRecognizer = _Class('ICDocCamImageQuadEditPanGestureRecognizer')
ICDocCamImageQuadEditKnobAccessibilityElement = _Class('ICDocCamImageQuadEditKnobAccessibilityElement')
...
ICDocCamExtractedThumbnailContainerView = _Class('ICDocCamExtractedThumbnailContainerView')
DCNotesTextureBackgroundView = _Class('DCNotesTextureBackgroundView')
DCNotesTextureView = _Class('DCNotesTextureView')
ICDocCamFilterViewControllerInvisibleRootView = _Class('ICDocCamFilterViewControllerInvisibleRootView')
...
ICDocCamExtractedDocumentThumbnailCell = _Class('ICDocCamExtractedDocumentThumbnailCell')
...
DCDocumentCameraViewController_ViewService = _Class('DCDocumentCameraViewController_ViewService')
DCDocumentCameraViewController_InProcess = _Class('DCDocumentCameraViewController_InProcess')
...
VNDocumentCameraViewController_InProcess = _Class('VNDocumentCameraViewController_InProcess')
VNDocumentCameraViewController_ViewService = _Class('VNDocumentCameraViewController_ViewService')
ICDocCamZoomablePageContentViewController = _Class('ICDocCamZoomablePageContentViewController')
ICDocCamPageContentViewController = _Class('ICDocCamPageContentViewController')
ICDocCamExtractedDocumentViewController = _Class('ICDocCamExtractedDocumentViewController')
...
ICDocCamThumbnailCollectionViewController = _Class('ICDocCamThumbnailCollectionViewController')
...
ICDocCamExtractedDocumentNavigationController = _Class('ICDocCamExtractedDocumentNavigationController')
