...
FigRoutePredictionFetchOneShotCompletion = _Class('FigRoutePredictionFetchOneShotCompletion')
...
FigResilientRemoteRoutingContextFactory = _Class('FigResilientRemoteRoutingContextFactory')
...
MX_DeviceManagementPolicyDidChangeObserver = _Class('MX_DeviceManagementPolicyDidChangeObserver')
