...
AKAuthorizationContainerViewControllerAnimator = _Class('AKAuthorizationContainerViewControllerAnimator')
...
AKAppleIDAuthenticationPurpleBuddyContext = _Class('AKAppleIDAuthenticationPurpleBuddyContext')
AKAppleIDAuthenticationInAppExtensionContext = _Class('AKAppleIDAuthenticationInAppExtensionContext')
AKAppleIDAuthenticationWatchBuddyContext = _Class('AKAppleIDAuthenticationWatchBuddyContext')
AKAppleIDAuthenticationUISurrogateContext = _Class('AKAppleIDAuthenticationUISurrogateContext')
...
AKBasicLoginContentViewControllerContainerView = _Class('AKBasicLoginContentViewControllerContainerView')
AKCodeEntryView = _Class('AKCodeEntryView')
AKAuthorizationPasswordRequestViewCell = _Class('AKAuthorizationPasswordRequestViewCell')
AKAuthorizationScopeDetailTableViewCell = _Class('AKAuthorizationScopeDetailTableViewCell')
...
AKSecondFactorCodeEntryContentViewController = _Class('AKSecondFactorCodeEntryContentViewController')
AKAuthorizationContainerViewController = _Class('AKAuthorizationContainerViewController')
AKAuthorizationContaineriPhoneViewController = _Class('AKAuthorizationContaineriPhoneViewController')
AKAuthorizationContaineriPadViewController = _Class('AKAuthorizationContaineriPadViewController')
...
AKAuthorizationInputPaneViewController = _Class('AKAuthorizationInputPaneViewController')
AKAuthorizationFirstTimePaneViewController = _Class('AKAuthorizationFirstTimePaneViewController')
AKAuthorizationPasswordAuthenticationViewController = _Class('AKAuthorizationPasswordAuthenticationViewController')
AKAuthorizationEmailEditPaneViewController = _Class('AKAuthorizationEmailEditPaneViewController')
