...
SSVSubscriptionEntitlementsCoordinator = _Class('SSVSubscriptionEntitlementsCoordinator')
...
SSVMutablePlayActivityEventContainerIDs = _Class('SSVMutablePlayActivityEventContainerIDs')
...
SSVMutablePlayActivityEnqueuerProperties = _Class('SSVMutablePlayActivityEnqueuerProperties')
...
SSVMediaSocialAdminPermissionsCoordinator = _Class('SSVMediaSocialAdminPermissionsCoordinator')
...
_SSVPlayActivityFlushSessionInformation = _Class('_SSVPlayActivityFlushSessionInformation')
_SSVPlayActivityEndpointRevisionInformation = _Class('_SSVPlayActivityEndpointRevisionInformation')
...
SSDistributedNotificationCenterObserver = _Class('SSDistributedNotificationCenterObserver')
...
SSDownloadAuthenticationChallengeSender = _Class('SSDownloadAuthenticationChallengeSender')
...
SSVSubscriptionEntitlementsSubscription = _Class('SSVSubscriptionEntitlementsSubscription')
