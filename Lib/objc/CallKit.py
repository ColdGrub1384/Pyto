...
CXCallDirectoryStoreIdentificationEntry = _Class('CXCallDirectoryStoreIdentificationEntry')
...
CXCallDirectoryMutablePhoneNumberEntryData = _Class('CXCallDirectoryMutablePhoneNumberEntryData')
CXCallDirectorySanitizer = _Class('CXCallDirectorySanitizer')
CXNetworkExtensionMessageControllerHostConnection = _Class('CXNetworkExtensionMessageControllerHostConnection')
CXNetworkExtensionMessageControllerXPCClient = _Class('CXNetworkExtensionMessageControllerXPCClient')
...
CXNetworkExtensionMessageControllerHost = _Class('CXNetworkExtensionMessageControllerHost')
...
CXCallDirectoryLabeledPhoneNumberEntryData = _Class('CXCallDirectoryLabeledPhoneNumberEntryData')
CXCallDirectoryMutableLabeledPhoneNumberEntryData = _Class('CXCallDirectoryMutableLabeledPhoneNumberEntryData')
