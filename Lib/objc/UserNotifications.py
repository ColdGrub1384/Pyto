...
UNUserNotificationCenterDelegateService = _Class('UNUserNotificationCenterDelegateService')
...
UNMutableNotificationAttachmentOptions = _Class('UNMutableNotificationAttachmentOptions')
UNNotificationRequest = _Class('UNNotificationRequest')
UNNotificationServiceExtension = _Class('UNNotificationServiceExtension')
UNUserNotificationCenterDelegateConnectionListener = _Class('UNUserNotificationCenterDelegateConnectionListener')
...
_UNNotificationServiceExtensionContext = _Class('_UNNotificationServiceExtensionContext')
_UNNotificationServiceExtensionHostContext = _Class('_UNNotificationServiceExtensionHostContext')
_UNNotificationServiceExtensionRemoteContext = _Class('_UNNotificationServiceExtensionRemoteContext')
