...
CLHealthAssessmentRecordTypeForDuration = _Class('CLHealthAssessmentRecordTypeForDuration')
...
CLSensorRecorderWriteSensorDataToFileForDateRange = _Class('CLSensorRecorderWriteSensorDataToFileForDateRange')
...
CLSensorRecorderSensorMetaRequestByDateRange = _Class('CLSensorRecorderSensorMetaRequestByDateRange')
