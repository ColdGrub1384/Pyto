...
_MNTracePlayerTimelineStreamSearchObject = _Class('_MNTracePlayerTimelineStreamSearchObject')
...
MNNavigationStatePredictingDestination = _Class('MNNavigationStatePredictingDestination')
...
MNAnnouncementStrategyDelayCompressDrop = _Class('MNAnnouncementStrategyDelayCompressDrop')
...
MNNavigationServiceDirectionsRequestTicket = _Class('MNNavigationServiceDirectionsRequestTicket')
...
MNCommuteDestinationLocationHistoryScore = _Class('MNCommuteDestinationLocationHistoryScore')
...
MNCommuteDestinationGeodesicDistanceScore = _Class('MNCommuteDestinationGeodesicDistanceScore')
MNCommuteDestinationNavigabilityScore = _Class('MNCommuteDestinationNavigabilityScore')
MNCommuteDestinationMapsSuggestionsScore = _Class('MNCommuteDestinationMapsSuggestionsScore')
