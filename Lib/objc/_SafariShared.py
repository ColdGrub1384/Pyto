...
WBSHistoryVisitsMatchingTimesPredicate = _Class('WBSHistoryVisitsMatchingTimesPredicate')
WBSHistoryVisitsWithIDPredicate = _Class('WBSHistoryVisitsWithIDPredicate')
WBSPasswordBreachCryptographicOperations = _Class('WBSPasswordBreachCryptographicOperations')
WBSSearchHelperConnectionManager = _Class('WBSSearchHelperConnectionManager')
WBSSameDocumentNavigationToHistoryVisitCorrelator = _Class('WBSSameDocumentNavigationToHistoryVisitCorrelator')
...
WBSHistoryServiceURLCompletionMatchData = _Class('WBSHistoryServiceURLCompletionMatchData')
WBSHistoryServiceURLCompletionMatchEntry = _Class('WBSHistoryServiceURLCompletionMatchEntry')
...
WBSHistoryVisitsMatchingOriginsPredicate = _Class('WBSHistoryVisitsMatchingOriginsPredicate')
...
WBSHistoryServiceDatabaseDelegateWeakProxy = _Class('WBSHistoryServiceDatabaseDelegateWeakProxy')
WBSHistoryServiceDatabaseDelegateProxy = _Class('WBSHistoryServiceDatabaseDelegateProxy')
...
WBSPasswordBreachConfigurationBagLoader = _Class('WBSPasswordBreachConfigurationBagLoader')
...
WBSPasswordBreachQueuedPasswordBagManager = _Class('WBSPasswordBreachQueuedPasswordBagManager')
...
WBSHistoryVisitsAndTombstonesInSyncWindowPredicate = _Class('WBSHistoryVisitsAndTombstonesInSyncWindowPredicate')
...
WBSWellKnownURLResponseCodeReliabilityChecker = _Class('WBSWellKnownURLResponseCodeReliabilityChecker')
WBSPasswordBreachNotificationManager = _Class('WBSPasswordBreachNotificationManager')
WBSHistoryVisitsInRedirectChainPredicate = _Class('WBSHistoryVisitsInRedirectChainPredicate')
WBSHistoryTagDatabaseController = _Class('WBSHistoryTagDatabaseController')
WBSHistoryTombstone = _Class('WBSHistoryTombstone')
WBSHistoryVisitsNeedingRecomputedVisitCountsPredicate = _Class('WBSHistoryVisitsNeedingRecomputedVisitCountsPredicate')
...
WBSFrequentlyVisitedSitesBannedURLStore = _Class('WBSFrequentlyVisitedSitesBannedURLStore')
...
WBSPasswordBreachConfigurationDictionaryUnpacker = _Class('WBSPasswordBreachConfigurationDictionaryUnpacker')
...
WBSFormAutoFillParsecFeedbackProcessor = _Class('WBSFormAutoFillParsecFeedbackProcessor')
WBSFormAutoFillParsecDomainPolicyProvider = _Class('WBSFormAutoFillParsecDomainPolicyProvider')
WBSPasswordWarningManager = _Class('WBSPasswordWarningManager')
WBSFormAutoFillParsecCrowdsourcedCorrectionsProcessor = _Class('WBSFormAutoFillParsecCrowdsourcedCorrectionsProcessor')
...
WBSFormAutoFillCorrectionsHistoryObserver = _Class('WBSFormAutoFillCorrectionsHistoryObserver')
...
WBSPasswordBreachKeychainCredentialSource = _Class('WBSPasswordBreachKeychainCredentialSource')
...
WBSContentBlockerStatisticsSQLiteStore = _Class('WBSContentBlockerStatisticsSQLiteStore')
...
WBSAutoplayQuirkWhitelistSnapshotTransformer = _Class('WBSAutoplayQuirkWhitelistSnapshotTransformer')
...
WBSPasswordWarningTopFraudTargetsTransformer = _Class('WBSPasswordWarningTopFraudTargetsTransformer')
WBSPasswordBreachConfigurationBagSnapshotTransformer = _Class('WBSPasswordBreachConfigurationBagSnapshotTransformer')
WBSAutoplayQuirkWhitelistManager = _Class('WBSAutoplayQuirkWhitelistManager')
WBSCrowdsourcedFeedbackDomainNormalizer = _Class('WBSCrowdsourcedFeedbackDomainNormalizer')
WBSFormAutoFillClassificationToCorrectionsTransformer = _Class('WBSFormAutoFillClassificationToCorrectionsTransformer')
