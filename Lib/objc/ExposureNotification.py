...
ENRegionServerExposureClassificationCriteria = _Class(
    "ENRegionServerExposureClassificationCriteria"
)
ENRegionServerAgencyConfiguration = _Class("ENRegionServerAgencyConfiguration")
ENRegionServerAgencyLocalizedConfiguration = _Class(
    "ENRegionServerAgencyLocalizedConfiguration"
)
ENRegionServerAgencyExposureNotificationConfiguration = _Class(
