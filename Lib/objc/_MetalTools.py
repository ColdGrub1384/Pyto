...
MTLCountersTraceResourceStateCommandEncoder = _Class('MTLCountersTraceResourceStateCommandEncoder')
...
MTLCountersResourceStateCommandEncoder = _Class('MTLCountersResourceStateCommandEncoder')
...
MTLGPUDebugParallelRenderCommandEncoder = _Class('MTLGPUDebugParallelRenderCommandEncoder')
MTLTelemetryParallelRenderCommandEncoder = _Class('MTLTelemetryParallelRenderCommandEncoder')
MTLCountersParallelRenderCommandEncoder = _Class('MTLCountersParallelRenderCommandEncoder')
MTLToolsAccelerationStructureCommandEncoder = _Class('MTLToolsAccelerationStructureCommandEncoder')
MTLDebugAccelerationStructureCommandEncoder = _Class('MTLDebugAccelerationStructureCommandEncoder')
