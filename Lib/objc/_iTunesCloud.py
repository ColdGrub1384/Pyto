...
ICMusicAccountNotificationsSettingsResponse = _Class('ICMusicAccountNotificationsSettingsResponse')
...
_ICUserCredentialProviderRequestSession = _Class('_ICUserCredentialProviderRequestSession')
...
ICMusicAccountNotificationsSettingsSwitch = _Class('ICMusicAccountNotificationsSettingsSwitch')
...
ICMusicSubscriptionStatusRemoteRequesting = _Class('ICMusicSubscriptionStatusRemoteRequesting')
ICDelegateAccountStoreSchema = _Class('ICDelegateAccountStoreSchema')
ICDAAPPropertyInfo = _Class('ICDAAPPropertyInfo')
_ICMusicSubscriptionLeaseIdentityCacheKey = _Class('_ICMusicSubscriptionLeaseIdentityCacheKey')
...
ICDelegationProviderServiceProtocolHandler = _Class('ICDelegationProviderServiceProtocolHandler')
...
ICStoreURLResponseAuthenticationProvider = _Class('ICStoreURLResponseAuthenticationProvider')
...
ICMutablePlayActivityEnqueuerProperties = _Class('ICMutablePlayActivityEnqueuerProperties')
...
ICLibraryAuthServiceClientTokenProvider = _Class('ICLibraryAuthServiceClientTokenProvider')
...
ICDelegationConsumerServiceSessionRequestResult = _Class('ICDelegationConsumerServiceSessionRequestResult')
...
ICMutablePlayActivityEventContainerIDs = _Class('ICMutablePlayActivityEventContainerIDs')
...
ICRemoteRequestOperationExecutionContext = _Class('ICRemoteRequestOperationExecutionContext')
...
ICMusicSubscriptionLeasePlaybackRequest = _Class('ICMusicSubscriptionLeasePlaybackRequest')
ICCloudAddReferral = _Class('ICCloudAddReferral')
_ICDelegationServiceConnectionPendingRequestContext = _Class('_ICDelegationServiceConnectionPendingRequestContext')
ICDelegationServiceConnection = _Class('ICDelegationServiceConnection')
ICRadioStationTrack = _Class('ICRadioStationTrack')
ICMusicAccountNotificationsSettingsManager = _Class('ICMusicAccountNotificationsSettingsManager')
...
ICStoreDialogResponseHandlerConfiguration = _Class('ICStoreDialogResponseHandlerConfiguration')
...
_ICPlayActivityFlushSessionInformation = _Class('_ICPlayActivityFlushSessionInformation')
_ICPlayActivityEndpointRevisionInformation = _Class('_ICPlayActivityEndpointRevisionInformation')
...
ICDelegationConsumerServiceSessionRequestInfo = _Class('ICDelegationConsumerServiceSessionRequestInfo')
...
ICLibraryAuthServiceBulkClientTokenResponse = _Class('ICLibraryAuthServiceBulkClientTokenResponse')
...
ICMusicSubscriptionPlaybackResponseItem = _Class('ICMusicSubscriptionPlaybackResponseItem')
ICDelegationConsumerServiceProtocolHandler = _Class('ICDelegationConsumerServiceProtocolHandler')
ICMusicSubscriptionAccountlessPlaybackRequest = _Class('ICMusicSubscriptionAccountlessPlaybackRequest')
...
ICLibraryAuthServiceClientTokenIdentifier = _Class('ICLibraryAuthServiceClientTokenIdentifier')
ICLibraryAuthServiceClientTokenResult = _Class('ICLibraryAuthServiceClientTokenResult')
ICLibraryAuthServiceClientTokenResponse = _Class('ICLibraryAuthServiceClientTokenResponse')
...
ICRemoteRequestOperationExecutionResponse = _Class('ICRemoteRequestOperationExecutionResponse')
...
ICMusicSubscriptionCarrierBundlingEligibilityResponse = _Class('ICMusicSubscriptionCarrierBundlingEligibilityResponse')
...
ICCloudContentTastePBFuseItemPreference = _Class('ICCloudContentTastePBFuseItemPreference')
...
ICSAPSessionPrepareFairPlayContextOperation = _Class('ICSAPSessionPrepareFairPlayContextOperation')
...
ICMusicSubscriptionCarrierBundlingEligibilityOperation = _Class('ICMusicSubscriptionCarrierBundlingEligibilityOperation')
ICFlushPlayActivityEventsOperation = _Class('ICFlushPlayActivityEventsOperation')
ICMusicSubscriptionStatusRequestOperation = _Class('ICMusicSubscriptionStatusRequestOperation')
ICMusicSubscriptionPlaybackRequestOperation = _Class('ICMusicSubscriptionPlaybackRequestOperation')
...
ICMusicAccountNotificationsSettingsRequestOperation = _Class('ICMusicAccountNotificationsSettingsRequestOperation')
...
ICPushNotificationsDisableTypesRequest = _Class('ICPushNotificationsDisableTypesRequest')
...
ICPushNotificationsRegisterAPNSTokenRequest = _Class('ICPushNotificationsRegisterAPNSTokenRequest')
ICMusicSubscriptionRecommendationsRequest = _Class('ICMusicSubscriptionRecommendationsRequest')
ICLibraryAuthServiceBulkClientTokenRequest = _Class('ICLibraryAuthServiceBulkClientTokenRequest')
ICLibraryAuthServiceClientTokenRequest = _Class('ICLibraryAuthServiceClientTokenRequest')
