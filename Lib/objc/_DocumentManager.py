...
DOCDocBrowserVC_UIActivityViewController = _Class('DOCDocBrowserVC_UIActivityViewController')
...
DOCTargetSelectionBrowserViewController = _Class('DOCTargetSelectionBrowserViewController')
