...
IMDCoreSpotlightMessageAttachmentIndexer = _Class('IMDCoreSpotlightMessageAttachmentIndexer')
IMDCoreSpotlightMessageDataDetectorsIndexer = _Class('IMDCoreSpotlightMessageDataDetectorsIndexer')
IMDCoreSpotlightMessageBalloonPluginIndexer = _Class('IMDCoreSpotlightMessageBalloonPluginIndexer')
IMDCoreSpotlightMessageMetadataIndexer = _Class('IMDCoreSpotlightMessageMetadataIndexer')
