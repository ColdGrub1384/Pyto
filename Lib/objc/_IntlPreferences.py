...
NSPersonNameComponentsFormatterPreferences = _Class('NSPersonNameComponentsFormatterPreferences')
IPFoundationNamePreferenceInfoProvider = _Class('IPFoundationNamePreferenceInfoProvider')
...
IP_unsupportedVariantsAddedByKeyboards_migrator = _Class('IP_unsupportedVariantsAddedByKeyboards_migrator')
