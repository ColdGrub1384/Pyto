...
_HKAudiogramDiagnosticSensitivityPoint = _Class('_HKAudiogramDiagnosticSensitivityPoint')
...
_HKDiagnosticTestResultComparisonFilter = _Class('_HKDiagnosticTestResultComparisonFilter')
...
_HKDiscreteQuantitySampleComparisonFilter = _Class('_HKDiscreteQuantitySampleComparisonFilter')
...
_HKSampleCountQueryServerConfiguration = _Class('_HKSampleCountQueryServerConfiguration')
_HKDatabaseChangesQueryServerConfiguration = _Class('_HKDatabaseChangesQueryServerConfiguration')
_HKCorrelationQueryServerConfiguration = _Class('_HKCorrelationQueryServerConfiguration')
_HKMultiTypeSampleQueryServerConfiguration = _Class('_HKMultiTypeSampleQueryServerConfiguration')
_HKStatisticsCollectionQueryServerConfiguration = _Class('_HKStatisticsCollectionQueryServerConfiguration')
_HKQuantityDistributionQueryServerConfiguration = _Class('_HKQuantityDistributionQueryServerConfiguration')
_HKCurrentActivitySummaryQueryServerConfiguration = _Class('_HKCurrentActivitySummaryQueryServerConfiguration')
_HKActivityStatisticsQueryServerConfiguration = _Class('_HKActivityStatisticsQueryServerConfiguration')
_HKWorkoutBuilderSampleQueryConfiguration = _Class('_HKWorkoutBuilderSampleQueryConfiguration')
HKActivitySummaryQueryServerConfiguration = _Class('HKActivitySummaryQueryServerConfiguration')
_HKAnchoredObjectQueryServerConfiguration = _Class('_HKAnchoredObjectQueryServerConfiguration')
_HKQuantitySeriesSampleQueryServerConfiguration = _Class('_HKQuantitySeriesSampleQueryServerConfiguration')
_HKWorkoutRouteQueryServerConfiguration = _Class('_HKWorkoutRouteQueryServerConfiguration')
...
_HKBackgroundObservationExtensionContext = _Class('_HKBackgroundObservationExtensionContext')
_HKBackgroundObservationExtensionHostContext = _Class('_HKBackgroundObservationExtensionHostContext')
_HKBackgroundObservationExtensionRemoteContext = _Class('_HKBackgroundObservationExtensionRemoteContext')
