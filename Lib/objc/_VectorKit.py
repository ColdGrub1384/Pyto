...
VKStylesheetVendorResourceManifestTileGroupObserverProxy = _Class(
...
VKCustomFeatureDataSourceObserverThunk = _Class(
...
VKMapAnnotationTrackingCameraController = _Class(
    "VKMapAnnotationTrackingCameraController"
)
VKGlobeAnnotationTrackingCameraController = _Class(
