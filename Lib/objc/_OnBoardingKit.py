...
OBOnBoardingKitPrivacySplashPresentation = _Class('OBOnBoardingKitPrivacySplashPresentation')
OBOnBoardingKitPrivacyLinkPresentation = _Class('OBOnBoardingKitPrivacyLinkPresentation')
OBOnBoardingKitPrivacyUnifiedAboutPresentation = _Class('OBOnBoardingKitPrivacyUnifiedAboutPresentation')
...
OBSetupAssistantDynamicLayoutController = _Class('OBSetupAssistantDynamicLayoutController')
...
OBSetupAssistantPasscodeViewController = _Class('OBSetupAssistantPasscodeViewController')
OBTouchIDEnrollmentWelcomeController = _Class('OBTouchIDEnrollmentWelcomeController')
OBSetupAssistantBulletedListController = _Class('OBSetupAssistantBulletedListController')
...
OBSetupAssistantLanguageLocaleController = _Class('OBSetupAssistantLanguageLocaleController')
