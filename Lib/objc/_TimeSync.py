...
TSRootMeanSquaredTimeIntervalErrorAnalysis = _Class('TSRootMeanSquaredTimeIntervalErrorAnalysis')
...
TSAudioTimeErrorCorrelatorPostUpsampler = _Class('TSAudioTimeErrorCorrelatorPostUpsampler')
