...
ExternalSequenceNumberToAttachmentNoteBodyToAttachmentMigrationPolicy = _Class(
...
ICMutableSetOfNumbersSecureUnarchiveFromDataTransformer = _Class(
    "ICMutableSetOfNumbersSecureUnarchiveFromDataTransformer"
)
ICNSStringOrNumberSecureUnarchiveFromDataTransformer = _Class(
