...
_AFBluetoothHeadphoneInEarDetectionStateMutation = _Class('_AFBluetoothHeadphoneInEarDetectionStateMutation')
...
_AFSpeakableUtterancePassThroughProvider = _Class('_AFSpeakableUtterancePassThroughProvider')
...
_AFSpeechRecordingAlertBehaviorMutation = _Class('_AFSpeechRecordingAlertBehaviorMutation')
...
_AFBluetoothWirelessSplitterSessionInfoMutation = _Class('_AFBluetoothWirelessSplitterSessionInfoMutation')
