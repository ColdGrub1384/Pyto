...
NWAWDLibnetcoreRNFActivityNotification = _Class('NWAWDLibnetcoreRNFActivityNotification')
NWPBPath = _Class('NWPBPath')
NWAWDMPTCPConnectionInterfaceReport = _Class('NWAWDMPTCPConnectionInterfaceReport')
NWAWDLibnetcoreConnectionDataUsageSnapshot = _Class('NWAWDLibnetcoreConnectionDataUsageSnapshot')
...
NWAWDLibnetcoreConnectionStatisticsReport = _Class('NWAWDLibnetcoreConnectionStatisticsReport')
...
NWAWDLibnetcoreTCPECNInterfaceStatsReport = _Class('NWAWDLibnetcoreTCPECNInterfaceStatsReport')
