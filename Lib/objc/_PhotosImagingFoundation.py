...
IPABestFitTotalPixelCountImageSizePolicy = _Class('IPABestFitTotalPixelCountImageSizePolicy')
IPABestFitEvenWidthTotalPixelCountImageSizePolicy = _Class('IPABestFitEvenWidthTotalPixelCountImageSizePolicy')
IPABestFitEvenTotalPixelCountImageSizePolicy = _Class('IPABestFitEvenTotalPixelCountImageSizePolicy')
...
IPAVideoAdjustmentStackSerializer_SLM_v10 = _Class('IPAVideoAdjustmentStackSerializer_SLM_v10')
IPAVideoAdjustmentStackSerializer_SLM_v11 = _Class('IPAVideoAdjustmentStackSerializer_SLM_v11')
...
IPAPhotoAdjustmentStackSerializer_SLM_v11 = _Class('IPAPhotoAdjustmentStackSerializer_SLM_v11')
