...
__NSCFURLLocalStreamTaskFromDataTaskDataBlobby = _Class('__NSCFURLLocalStreamTaskFromDataTaskDataBlobby')
...
__NSCFURLSessionTaskDependencyTreeNode = _Class('__NSCFURLSessionTaskDependencyTreeNode')
NSURLSessionTaskDependencyDescription = _Class('NSURLSessionTaskDependencyDescription')
__NSURLSessionTaskDependencyResourceIdentifier = _Class('__NSURLSessionTaskDependencyResourceIdentifier')
...
_NSHTTPAlternativeServicesSpeculativeEntry = _Class('_NSHTTPAlternativeServicesSpeculativeEntry')
...
__NSCFURLSessionTaskActiveStreamDependencyInfo = _Class('__NSCFURLSessionTaskActiveStreamDependencyInfo')
__CFN_PathPolicyManager = _Class('__CFN_PathPolicyManager')
__CFN_CoalescingDomainHolder = _Class('__CFN_CoalescingDomainHolder')
_NSURLSessionConnectionEstablishProperties = _Class('_NSURLSessionConnectionEstablishProperties')
...
_NSURLSessionConnectionBeginProperties = _Class('_NSURLSessionConnectionBeginProperties')
...
__NSURLSessionEffectiveConfiguration_Base = _Class('__NSURLSessionEffectiveConfiguration_Base')
...
__NSCFBackgroundAVAggregateAssetDownloadTask = _Class('__NSCFBackgroundAVAggregateAssetDownloadTask')
__NSCFBackgroundAVAssetDownloadTask = _Class('__NSCFBackgroundAVAssetDownloadTask')
__NSCFBackgroundAVAggregateAssetDownloadTaskNoChildTask = _Class('__NSCFBackgroundAVAggregateAssetDownloadTaskNoChildTask')
...
__NSCFURLLocalTCPIOStreamTaskFromDataTask = _Class('__NSCFURLLocalTCPIOStreamTaskFromDataTask')
...
_NSCFTranslatedFileURLProtocol_PIMPL_7 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_7')
_NSCFTranslatedFileURLProtocol_PIMPL_6 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_6')
_NSCFTranslatedFileURLProtocol_PIMPL_5 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_5')
_NSCFTranslatedFileURLProtocol_PIMPL_4 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_4')
_NSCFTranslatedFileURLProtocol_PIMPL_3 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_3')
_NSCFTranslatedFileURLProtocol_PIMPL_2 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_2')
_NSCFTranslatedFileURLProtocol_PIMPL_1 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_1')
_NSCFTranslatedFileURLProtocol_PIMPL_0 = _Class('_NSCFTranslatedFileURLProtocol_PIMPL_0')
