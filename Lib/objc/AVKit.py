...
AVPresentationContainerViewAppearanceProxy = _Class('AVPresentationContainerViewAppearanceProxy')
...
AVPlayerViewControllerAnimationCoordinator = _Class('AVPlayerViewControllerAnimationCoordinator')
...
AVPictureInPictureControllerContentSource = _Class('AVPictureInPictureControllerContentSource')
...
AVUserInteractionObserverGestureRecognizer = _Class('AVUserInteractionObserverGestureRecognizer')
...
AVSampleBufferDisplayLayerPlayerController = _Class('AVSampleBufferDisplayLayerPlayerController')
...
AVTurboModePlaybackControlsPlaceholderView = _Class('AVTurboModePlaybackControlsPlaceholderView')
...
AVPlayerViewControllerCustomControlsView = _Class('AVPlayerViewControllerCustomControlsView')
AVPlayerViewControllerCustomControlsViewLayoutMarginsGuideProvidingView = _Class('AVPlayerViewControllerCustomControlsViewLayoutMarginsGuideProvidingView')
AVLoadingButtonView = _Class('AVLoadingButtonView')
AVStatusBarBackgroundGradientViewSubview = _Class('AVStatusBarBackgroundGradientViewSubview')
