...
CHSConfiguredWidgetContainerDescriptorsBox = _Class('CHSConfiguredWidgetContainerDescriptorsBox')
CHSConfiguredWidgetContainerDescriptor = _Class('CHSConfiguredWidgetContainerDescriptor')
...
CHSApplicationProcessStateChangeConsumer = _Class('CHSApplicationProcessStateChangeConsumer')
