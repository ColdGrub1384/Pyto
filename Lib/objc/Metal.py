...
_MTLIndirectDispatchThreadgroupsArguments = _Class('_MTLIndirectDispatchThreadgroupsArguments')
_MTLIndirectTessellationFactorArguments = _Class('_MTLIndirectTessellationFactorArguments')
_MTLIndirectDrawIndexedPatchesArguments = _Class('_MTLIndirectDrawIndexedPatchesArguments')
...
_MTLSWRaytracingAccelerationStructureCommandEncoder = _Class('_MTLSWRaytracingAccelerationStructureCommandEncoder')
...
_MTLAccelerationStructureCommandEncoder = _Class('_MTLAccelerationStructureCommandEncoder')
