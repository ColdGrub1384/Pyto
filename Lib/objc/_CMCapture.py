...
FigCaptureMetadataSinkPipelineConfiguration = _Class(
...
BWNoiseReductionAndSharpeningParameters = _Class(
...
FigCaptureSessionServerKeyedUnarchiverDelegate = _Class(
    "FigCaptureSessionServerKeyedUnarchiverDelegate"
)
...
BWMultiStreamCameraSourceNodeConfiguration = _Class(
...
FigCapturePreviewSinkPipelineConfiguration = _Class(
...
FigCaptureStillImageSinkPipelineSessionStorage = _Class(
...
BWIOSurfaceCompressionStatisticsAnalyticsPayload = _Class(
...
FigCaptureSessionConfigurationKeyedUnarchiverDelegate = _Class(
    "FigCaptureSessionConfigurationKeyedUnarchiverDelegate"
)
FigCaptureSinkConfiguration = _Class("FigCaptureSinkConfiguration")
FigCaptureCameraCalibrationDataSinkConfiguration = _Class(
...
FigCaptureAudioPreviewSinkConfiguration = _Class(
    "FigCaptureAudioPreviewSinkConfiguration"
)
FigCaptureVideoThumbnailSinkConfiguration = _Class(
    "FigCaptureVideoThumbnailSinkConfiguration"
)
FigCaptureVideoPreviewSinkConfiguration = _Class(
...
FigCameraCalibrationDataCaptureConnectionConfiguration = _Class(
    "FigCameraCalibrationDataCaptureConnectionConfiguration"
)
FigMetadataItemCaptureConnectionConfiguration = _Class(
    "FigMetadataItemCaptureConnectionConfiguration"
)
FigMetadataObjectCaptureConnectionConfiguration = _Class(
    "FigMetadataObjectCaptureConnectionConfiguration"
)
FigAudioCaptureConnectionConfiguration = _Class(
    "FigAudioCaptureConnectionConfiguration"
)
FigVideoCaptureConnectionConfiguration = _Class(
    "FigVideoCaptureConnectionConfiguration"
)
FigPointCloudDataCaptureConnectionConfiguration = _Class(
    "FigPointCloudDataCaptureConnectionConfiguration"
)
FigVisionDataCaptureConnectionConfiguration = _Class(
    "FigVisionDataCaptureConnectionConfiguration"
)
FigDepthDataCaptureConnectionConfiguration = _Class(
...
FigCaptureSessionActiveCameraCaptureSource = _Class(
...
FigCaptureCameraSourcePipelineConfiguration = _Class(
...
BWStillImageCaptureStreamFrameCounters = _Class(
...
BWStillImageCaptureDelegateCallbackInfo = _Class(
...
BWDeferredContainerPixelBufferPoolWrapper = _Class(
...
FigCaptureAutoFocusPositionSensorCalibrationIStopZEstimateDeltaHistory = _Class(
...
BWNodeStillImageReferenceFrameBracketedCaptureSequenceNumberMessage = _Class(
...
FigCaptureSessionParsedMovieFileSinkConfiguration = _Class(
    "FigCaptureSessionParsedMovieFileSinkConfiguration"
)
FigCaptureSessionParsedMetadataSinkConfiguration = _Class(
    "FigCaptureSessionParsedMetadataSinkConfiguration"
)
FigCaptureSessionParsedDepthDataSinkConfiguration = _Class(
    "FigCaptureSessionParsedDepthDataSinkConfiguration"
)
FigCaptureSessionParsedVisionDataSinkConfiguration = _Class(
    "FigCaptureSessionParsedVisionDataSinkConfiguration"
)
FigCaptureSessionParsedVideoDataSinkConfiguration = _Class(
    "FigCaptureSessionParsedVideoDataSinkConfiguration"
)
FigCaptureSessionParsedStillImageSinkConfiguration = _Class(
    "FigCaptureSessionParsedStillImageSinkConfiguration"
)
FigCaptureSessionParsedPreviewSinkConfiguration = _Class(
    "FigCaptureSessionParsedPreviewSinkConfiguration"
)
FigCaptureSessionParsedMicSourceConfiguration = _Class(
    "FigCaptureSessionParsedMicSourceConfiguration"
)
FigCaptureSessionParsedCameraSourceConfiguration = _Class(
    "FigCaptureSessionParsedCameraSourceConfiguration"
)
BWStillImageConditionalRouterConfiguration = _Class(
    "BWStillImageConditionalRouterConfiguration"
)
BWStillImageConditionalRouterOverCaptureConfiguration = _Class(
    "BWStillImageConditionalRouterOverCaptureConfiguration"
)
BWStillImageConditionalRouterInferenceConfiguration = _Class(
    "BWStillImageConditionalRouterInferenceConfiguration"
)
BWStillImageConditionalRouterUBConfiguration = _Class(
    "BWStillImageConditionalRouterUBConfiguration"
)
BWStillImageConditionalRouterPersonSegmentationAndMattingConfiguration = _Class(
    "BWStillImageConditionalRouterPersonSegmentationAndMattingConfiguration"
)
BWStillImageConditionalRouterLandmarksConfiguration = _Class(
...
BWFigVideoCaptureSynchronizedStreamsGroup = _Class(
...
FigCaptureMovieFileSinkTailPipelineConfiguration = _Class(
    "FigCaptureMovieFileSinkTailPipelineConfiguration"
)
FigCaptureMovieFileSinkMiddlePipelineConfiguration = _Class(
...
FigCaptureStillImageUnifiedBracketingSinkPipeline = _Class(
...
FigCaptureMovieFileSinkHeadPipelineConfiguration = _Class(
    "FigCaptureMovieFileSinkHeadPipelineConfiguration"
)
FigCaptureMovieFileSinkPipelineConfiguration = _Class(
...
FigCaptureBaseStillImageSinkPipelineConfiguration = _Class(
    "FigCaptureBaseStillImageSinkPipelineConfiguration"
)
FigCaptureStillImageSinkPipelineConfiguration = _Class(
    "FigCaptureStillImageSinkPipelineConfiguration"
)
FigCaptureStillImageUnifiedBracketingSinkPipelineConfiguration = _Class(
...
FigStillImageSharedProcessingResources = _Class(
    "FigStillImageSharedProcessingResources"
)
...
BWIntermediateJPEGCompressedBufferAssociatedSemaphore = _Class(
...
FigCaptureDeferredPhotoProcessorRequest = _Class(
...
FigCaptureAutoFocusPositionSensorCalibrationContext = _Class(
    "FigCaptureAutoFocusPositionSensorCalibrationContext"
)
FigCaptureAPSSphereInteractionCalibrationContext = _Class(
    "FigCaptureAPSSphereInteractionCalibrationContext"
)
FigCaptureSphereEndStopCalibrationContext = _Class(
...
BWDeepFusionProcessorControllerConfiguration = _Class(
    "BWDeepFusionProcessorControllerConfiguration"
)
BWStereoDisparityProcessorControllerConfiguration = _Class(
...
BWStillImageTimeMachineFrameCoordinatorNode = _Class(
...
BWStillImageDualPhotoFacePropagatorNode = _Class(
...
BWStreamingCVAFilterRendererParameters = _Class(
...
FigFlatToNSDictionaryWrapperKeyEnumerator = _Class(
