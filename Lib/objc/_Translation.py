...
FTTextToSpeechStreamingStreamingContext = _Class('FTTextToSpeechStreamingStreamingContext')
FTTextToSpeechRouterStreamingStreamingContext = _Class('FTTextToSpeechRouterStreamingStreamingContext')
...
FTMutableLanguageDetectionStreamingResponse = _Class('FTMutableLanguageDetectionStreamingResponse')
FTLanguageDetectionStreamingRequest = _Class('FTLanguageDetectionStreamingRequest')
FTMutableLanguageDetectionStreamingRequest = _Class('FTMutableLanguageDetectionStreamingRequest')
FTTextToSpeechStreamingStreamingResponse = _Class('FTTextToSpeechStreamingStreamingResponse')
FTMutableTextToSpeechStreamingStreamingResponse = _Class('FTMutableTextToSpeechStreamingStreamingResponse')
FTTextToSpeechStreamingStreamingRequest = _Class('FTTextToSpeechStreamingStreamingRequest')
FTMutableTextToSpeechStreamingStreamingRequest = _Class('FTMutableTextToSpeechStreamingStreamingRequest')
FTTextToSpeechRouterStreamingStreamingResponse = _Class('FTTextToSpeechRouterStreamingStreamingResponse')
FTMutableTextToSpeechRouterStreamingStreamingResponse = _Class('FTMutableTextToSpeechRouterStreamingStreamingResponse')
FTTextToSpeechRouterStreamingStreamingRequest = _Class('FTTextToSpeechRouterStreamingStreamingRequest')
FTMutableTextToSpeechRouterStreamingStreamingRequest = _Class('FTMutableTextToSpeechRouterStreamingStreamingRequest')
FTBatchTranslationStreamingResponse = _Class('FTBatchTranslationStreamingResponse')
FTMutableBatchTranslationStreamingResponse = _Class('FTMutableBatchTranslationStreamingResponse')
FTBatchTranslationStreamingRequest = _Class('FTBatchTranslationStreamingRequest')
FTMutableBatchTranslationStreamingRequest = _Class('FTMutableBatchTranslationStreamingRequest')
FTSpeechTranslationStreamingResponse = _Class('FTSpeechTranslationStreamingResponse')
FTMutableSpeechTranslationStreamingResponse = _Class('FTMutableSpeechTranslationStreamingResponse')
FTSpeechTranslationStreamingRequest = _Class('FTSpeechTranslationStreamingRequest')
FTMutableSpeechTranslationStreamingRequest = _Class('FTMutableSpeechTranslationStreamingRequest')
FTMultilingualStreamingResponse = _Class('FTMultilingualStreamingResponse')
FTMutableMultilingualStreamingResponse = _Class('FTMutableMultilingualStreamingResponse')
...
FTMutableBatchRecoverStreamingResponse = _Class('FTMutableBatchRecoverStreamingResponse')
...
FTMutableStartLanguageDetectionRequest = _Class('FTMutableStartLanguageDetectionRequest')
FTBatchTranslationCacheContainer = _Class('FTBatchTranslationCacheContainer')
FTMutableBatchTranslationCacheContainer = _Class('FTMutableBatchTranslationCacheContainer')
...
FTMutableBatchTranslationRequest_Paragraph = _Class('FTMutableBatchTranslationRequest_Paragraph')
...
FTMutableStartMultilingualSpeechRequest = _Class('FTMutableStartMultilingualSpeechRequest')
FTLanguageParameters = _Class('FTLanguageParameters')
FTMutableLanguageParameters = _Class('FTMutableLanguageParameters')
FTShortcutFuzzyMatchResponse_ShortcutScorePair = _Class('FTShortcutFuzzyMatchResponse_ShortcutScorePair')
FTMutableShortcutFuzzyMatchResponse_ShortcutScorePair = _Class('FTMutableShortcutFuzzyMatchResponse_ShortcutScorePair')
...
FTShortcutFuzzyMatchRequest_StringTokenPair = _Class('FTShortcutFuzzyMatchRequest_StringTokenPair')
FTMutableShortcutFuzzyMatchRequest_StringTokenPair = _Class('FTMutableShortcutFuzzyMatchRequest_StringTokenPair')
...
FTSpeechTranslationServerEndpointFeatures = _Class('FTSpeechTranslationServerEndpointFeatures')
FTMutableSpeechTranslationServerEndpointFeatures = _Class('FTMutableSpeechTranslationServerEndpointFeatures')
FTSpeechTranslationTextToSpeechResponse = _Class('FTSpeechTranslationTextToSpeechResponse')
FTMutableSpeechTranslationTextToSpeechResponse = _Class('FTMutableSpeechTranslationTextToSpeechResponse')
FTSpeechTranslationMtResponse_TranslationPhrase = _Class('FTSpeechTranslationMtResponse_TranslationPhrase')
FTMutableSpeechTranslationMtResponse_TranslationPhrase = _Class('FTMutableSpeechTranslationMtResponse_TranslationPhrase')
...
FTSpeechTranslationFinalRecognitionResponse = _Class('FTSpeechTranslationFinalRecognitionResponse')
FTMutableSpeechTranslationFinalRecognitionResponse = _Class('FTMutableSpeechTranslationFinalRecognitionResponse')
FTSpeechTranslationPartialRecognitionResponse = _Class('FTSpeechTranslationPartialRecognitionResponse')
FTMutableSpeechTranslationPartialRecognitionResponse = _Class('FTMutableSpeechTranslationPartialRecognitionResponse')
FTStartSpeechTranslationLoggingRequest = _Class('FTStartSpeechTranslationLoggingRequest')
FTMutableStartSpeechTranslationLoggingRequest = _Class('FTMutableStartSpeechTranslationLoggingRequest')
FTStartSpeechTranslationRequest = _Class('FTStartSpeechTranslationRequest')
FTMutableStartSpeechTranslationRequest = _Class('FTMutableStartSpeechTranslationRequest')
...
FTMutableFinalTextToSpeechStreamingResponse = _Class('FTMutableFinalTextToSpeechStreamingResponse')
FTPartialTextToSpeechStreamingResponse = _Class('FTPartialTextToSpeechStreamingResponse')
FTMutablePartialTextToSpeechStreamingResponse = _Class('FTMutablePartialTextToSpeechStreamingResponse')
FTBeginTextToSpeechStreamingResponse = _Class('FTBeginTextToSpeechStreamingResponse')
FTMutableBeginTextToSpeechStreamingResponse = _Class('FTMutableBeginTextToSpeechStreamingResponse')
FTStartTextToSpeechStreamingRequest_ContextInfoEntry = _Class('FTStartTextToSpeechStreamingRequest_ContextInfoEntry')
FTMutableStartTextToSpeechStreamingRequest_ContextInfoEntry = _Class('FTMutableStartTextToSpeechStreamingRequest_ContextInfoEntry')
FTStartTextToSpeechStreamingRequest = _Class('FTStartTextToSpeechStreamingRequest')
FTMutableStartTextToSpeechStreamingRequest = _Class('FTMutableStartTextToSpeechStreamingRequest')
...
FTTextToSpeechRequest_ContextInfoEntry = _Class('FTTextToSpeechRequest_ContextInfoEntry')
FTMutableTextToSpeechRequest_ContextInfoEntry = _Class('FTMutableTextToSpeechRequest_ContextInfoEntry')
...
FTMutableTextToSpeechRequestExperiment = _Class('FTMutableTextToSpeechRequestExperiment')
FTTextToSpeechRequestContext_ContextInfoEntry = _Class('FTTextToSpeechRequestContext_ContextInfoEntry')
FTMutableTextToSpeechRequestContext_ContextInfoEntry = _Class('FTMutableTextToSpeechRequestContext_ContextInfoEntry')
...
FTTranslationResponse_TranslationPhrase = _Class('FTTranslationResponse_TranslationPhrase')
FTMutableTranslationResponse_TranslationPhrase = _Class('FTMutableTranslationResponse_TranslationPhrase')
FTTranslationResponse_TranslationToken = _Class('FTTranslationResponse_TranslationToken')
FTMutableTranslationResponse_TranslationToken = _Class('FTMutableTranslationResponse_TranslationToken')
...
FTMutableCreateLanguageProfileResponse = _Class('FTMutableCreateLanguageProfileResponse')
...
FTFinishAudio_ServerFeatureLatencyDistributionEntry = _Class('FTFinishAudio_ServerFeatureLatencyDistributionEntry')
FTMutableFinishAudio_ServerFeatureLatencyDistributionEntry = _Class('FTMutableFinishAudio_ServerFeatureLatencyDistributionEntry')
...
FTMutablePartialSpeechRecognitionResponse = _Class('FTMutablePartialSpeechRecognitionResponse')
FTFinalSpeechRecognitionResponse = _Class('FTFinalSpeechRecognitionResponse')
FTMutableFinalSpeechRecognitionResponse = _Class('FTMutableFinalSpeechRecognitionResponse')
FTAudioAnalytics_AcousticFeaturesEntry = _Class('FTAudioAnalytics_AcousticFeaturesEntry')
FTMutableAudioAnalytics_AcousticFeaturesEntry = _Class('FTMutableAudioAnalytics_AcousticFeaturesEntry')
FTAudioAnalytics_SpeechRecognitionFeaturesEntry = _Class('FTAudioAnalytics_SpeechRecognitionFeaturesEntry')
FTMutableAudioAnalytics_SpeechRecognitionFeaturesEntry = _Class('FTMutableAudioAnalytics_SpeechRecognitionFeaturesEntry')
...
FTMutableRequestStatsResponse_DoubleStat = _Class('FTMutableRequestStatsResponse_DoubleStat')
FTRequestStatsResponse_Int32Stat = _Class('FTRequestStatsResponse_Int32Stat')
FTMutableRequestStatsResponse_Int32Stat = _Class('FTMutableRequestStatsResponse_Int32Stat')
FTRequestStatsResponse_BoolStat = _Class('FTRequestStatsResponse_BoolStat')
FTMutableRequestStatsResponse_BoolStat = _Class('FTMutableRequestStatsResponse_BoolStat')
...
FTMutableSetAlternateRecognitionSausage = _Class('FTMutableSetAlternateRecognitionSausage')
...
FTMutableRecognitionPhraseTokensAlternatives = _Class('FTMutableRecognitionPhraseTokensAlternatives')
...
_LTCombinedRouteParagraphTranslationRequest = _Class('_LTCombinedRouteParagraphTranslationRequest')
...
_LTLanguageDetectorFeatureCombinationModel = _Class('_LTLanguageDetectorFeatureCombinationModel')
