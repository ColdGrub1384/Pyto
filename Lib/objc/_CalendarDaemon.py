...
CADCalendarDatabaseCalStoreInfoProvider = _Class('CADCalendarDatabaseCalStoreInfoProvider')
CADBlacklistedDelegateAccountAccessHandler = _Class('CADBlacklistedDelegateAccountAccessHandler')
...
CADCalendarDatabaseCalCalendarInfoProvider = _Class('CADCalendarDatabaseCalCalendarInfoProvider')
...
CADMCProfileConnectionManagedConfigurationHandler = _Class('CADMCProfileConnectionManagedConfigurationHandler')
...
CADDatabaseStorageManagementOperationGroup = _Class('CADDatabaseStorageManagementOperationGroup')
...
CADNotificationCenterVisibleEventsPredicate = _Class('CADNotificationCenterVisibleEventsPredicate')
...
CADNaturalLanguageSuggestedEventsSearchPredicate = _Class('CADNaturalLanguageSuggestedEventsSearchPredicate')
EKReminderPredicate = _Class('EKReminderPredicate')
CADEventCreatedFromSuggestionPredicate = _Class('CADEventCreatedFromSuggestionPredicate')
...
CADCalendarItemsWithExternalIdentifierPredicate = _Class('CADCalendarItemsWithExternalIdentifierPredicate')
CADCalSearchOperation = _Class('CADCalSearchOperation')
CADCalLocationSearchOperation = _Class('CADCalLocationSearchOperation')
_CADFetchCalendarItemsWithPredicateOperation = _Class('_CADFetchCalendarItemsWithPredicateOperation')
