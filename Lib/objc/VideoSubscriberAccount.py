...
VSIdentityProviderAvailabilityInfoCenter = _Class('VSIdentityProviderAvailabilityInfoCenter')
...
VSSubscriptionSourceKindPropertyListValueTransformer = _Class('VSSubscriptionSourceKindPropertyListValueTransformer')
VSStoreAllAppsResponseDictionaryValueTransformer = _Class('VSStoreAllAppsResponseDictionaryValueTransformer')
...
VSAuthenticationSchemeValueTransformer = _Class('VSAuthenticationSchemeValueTransformer')
VSSubscriptionAccountHashValueTransformer = _Class('VSSubscriptionAccountHashValueTransformer')
VSCompoundValueTransformer = _Class('VSCompoundValueTransformer')
VSStoreAllAppsResponseValueTransformer = _Class('VSStoreAllAppsResponseValueTransformer')
VSStoreAppsResponseValueTransformer = _Class('VSStoreAppsResponseValueTransformer')
VSStoreAppsResponseDictionaryValueTransformer = _Class('VSStoreAppsResponseDictionaryValueTransformer')
VSFailableValueTransformer = _Class('VSFailableValueTransformer')
VSSubscriptionAvailabilityTypeJSONValueTransformer = _Class('VSSubscriptionAvailabilityTypeJSONValueTransformer')
...
VSDeveloperIdentityProviderFetchAllOperation = _Class('VSDeveloperIdentityProviderFetchAllOperation')
...
VSDeveloperIdentityProviderChangeOperation = _Class('VSDeveloperIdentityProviderChangeOperation')
VSIdentityProviderFetchAllAppsOperation = _Class('VSIdentityProviderFetchAllAppsOperation')
