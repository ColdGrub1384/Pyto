...
PFUbiquityRecordsImporterSchedulingContext = _Class(
...
PFUbiquityMetadataFactoryFilePresenter = _Class(
    "PFUbiquityMetadataFactoryFilePresenter"
)
NSCloudKitMirroringDelegatePreJazzkonMetadata = _Class(
...
PFCloudKitThrottledNotificationObserver = _Class(
...
_NSFaultingMutableOrderedSetMutationMethods = _Class(
...
NSSQLSubqueryExpressionIntermediatePredicateVisitor = _Class(
...
NSSQLUbiquitizedStoreConnectionManager = _Class(
...
NSPrivateCoreDataClassForFindingBundle = _Class(
...
PFCloudKitImporterFetchRecordsWorkItem = _Class(
...
NSCloudKitMirroringDelegateSetupResult = _Class(
    "NSCloudKitMirroringDelegateSetupResult"
)
NSCloudKitMirroringExportProgressResult = _Class(
...
NSCloudKitMirroringDelegateSerializationRequestResult = _Class(
    "NSCloudKitMirroringDelegateSerializationRequestResult"
)
NSPersistentCloudKitContainerEventResult = _Class(
...
NSPersistentCloudKitContainerEventRequest = _Class(
...
NSCloudKitMirroringDelegateSetupRequest = _Class(
    "NSCloudKitMirroringDelegateSetupRequest"
)
NSCloudKitMirroringExportProgressRequest = _Class(
    "NSCloudKitMirroringExportProgressRequest"
)
NSCloudKitMirroringDelegateSerializationRequest = _Class(
    "NSCloudKitMirroringDelegateSerializationRequest"
)
NSCloudKitMirroringInitializeSchemaRequest = _Class(
    "NSCloudKitMirroringInitializeSchemaRequest"
)
NSCloudKitMirroringResetMetadataRequest = _Class(
...
NSSQLPersistentHistoryChangeRequestContext = _Class(
...
_NSXPCStoreObjectIDArrayConstantValueExpression = _Class(
...
_NSCoreDataConstraintViolationException = _Class(
...
NSCKRecordZoneQueryPredicateTransformer = _Class(
...
NSMemoryStoreEqualityPredicateOperator = _Class(
...
PFUbiquityBaselineRollResponseOperation = _Class(
