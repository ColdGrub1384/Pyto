...
CRRecognizerAsyncFeatureBatchProviderV1 = _Class('CRRecognizerAsyncFeatureBatchProviderV1')
...
CRTextRecognizerTopKModelEspressoOutput = _Class('CRTextRecognizerTopKModelEspressoOutput')
...
CRTextSequenceRecognizerTopKModelEspresso = _Class('CRTextSequenceRecognizerTopKModelEspresso')
...
CRTextSequenceRecognizerModelCoreMLOutput = _Class('CRTextSequenceRecognizerModelCoreMLOutput')
CRTextSequenceRecognizerModelCoreMLInput = _Class('CRTextSequenceRecognizerModelCoreMLInput')
