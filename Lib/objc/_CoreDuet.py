...
_DKKnowledgeStorageSimpleKeyValueStore = _Class('_DKKnowledgeStorageSimpleKeyValueStore')
...
_CDInteractionStoreNotificationReceiver = _Class('_CDInteractionStoreNotificationReceiver')
...
_DKRoutineLocationOfInterestTypeCategory = _Class('_DKRoutineLocationOfInterestTypeCategory')
...
_CDCloudFamilyPETDataCollectionUtilities = _Class('_CDCloudFamilyPETDataCollectionUtilities')
...
_DKDeviceActivityLevelFeedbackMetadataKey = _Class('_DKDeviceActivityLevelFeedbackMetadataKey')
...
_DKPeopleSuggesterOutputForSiriNLMetadataKey = _Class('_DKPeopleSuggesterOutputForSiriNLMetadataKey')
_DKMapsShareEtaFeedbackMetadataKey = _Class('_DKMapsShareEtaFeedbackMetadataKey')
_DKShareSheetSuggestLessFeedbackMetadataKey = _Class('_DKShareSheetSuggestLessFeedbackMetadataKey')
...
_DKLocationApplicationActivityMetadataKey = _Class('_DKLocationApplicationActivityMetadataKey')
...
_CDCloudFamilyPETDataCollectionSession = _Class('_CDCloudFamilyPETDataCollectionSession')
...
_CDPSimpleModelParameterManagerAccountState = _Class('_CDPSimpleModelParameterManagerAccountState')
_CDPSimpleModelParameterManagerTuningValue = _Class('_CDPSimpleModelParameterManagerTuningValue')
...
_DKEligibleForPredictionTombstoneRequirement = _Class('_DKEligibleForPredictionTombstoneRequirement')
_DKAppActivityStreamTombstoneRequirement = _Class('_DKAppActivityStreamTombstoneRequirement')
_DKAppIntentsStreamTombstoneRequirement = _Class('_DKAppIntentsStreamTombstoneRequirement')
...
_DKPerformSyncDownPeerAdditionsOperation = _Class('_DKPerformSyncDownPeerAdditionsOperation')
_DKPerformSyncUpHistoryDeletionsOperation = _Class('_DKPerformSyncUpHistoryDeletionsOperation')
_DKPerformSyncUpHistoryAdditionsOperation = _Class('_DKPerformSyncUpHistoryAdditionsOperation')
_DKPerformSyncDownPeerDeletionsOperation = _Class('_DKPerformSyncDownPeerDeletionsOperation')
