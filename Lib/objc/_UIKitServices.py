...
UISApplicationSupportDisplayEdgeInsetsWrapper = _Class(
...
UISFetchContentInBackgroundActionResponse = _Class(
...
UISMutableApplicationInitializationContext = _Class(
    "UISMutableApplicationInitializationContext"
)
UISApplicationInitializationContextParameters = _Class(
