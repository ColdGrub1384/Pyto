...
_ASAccountAuthenticationModificationExtensionManager = _Class('_ASAccountAuthenticationModificationExtensionManager')
...
_ASAccountAuthenticationModificationExtensionHostContext = _Class('_ASAccountAuthenticationModificationExtensionHostContext')
_ASCredentialProviderExtensionHostContext = _Class('_ASCredentialProviderExtensionHostContext')
...
_ASPasswordCredentialAuthenticationViewController = _Class('_ASPasswordCredentialAuthenticationViewController')
_ASCredentialProviderExtensionConfigurationViewController = _Class('_ASCredentialProviderExtensionConfigurationViewController')
_ASAccountAuthenticationModificationHostViewController = _Class('_ASAccountAuthenticationModificationHostViewController')
...
_ASAccountAuthenticationModificationRemoteViewController = _Class('_ASAccountAuthenticationModificationRemoteViewController')
