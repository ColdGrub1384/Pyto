...
ISBiometricUpdateTouchIDSettingsOperation = _Class('ISBiometricUpdateTouchIDSettingsOperation')
...
ISBiometricAuthorizationDialogOperation = _Class('ISBiometricAuthorizationDialogOperation')
