...
CPAnalyticsPropertyProviderClassLoader = _Class('CPAnalyticsPropertyProviderClassLoader')
...
PhotosAnalyticsDemographicPropertyProvider = _Class('PhotosAnalyticsDemographicPropertyProvider')
...
CPAnalyticsKnowledgeStoreDatasetSample = _Class('CPAnalyticsKnowledgeStoreDatasetSample')
