...
EMFDefaultAutocompleteCandidateProvider = _Class('EMFDefaultAutocompleteCandidateProvider')
...
EMFIndexStrategySingleStemmedIndexOnly = _Class('EMFIndexStrategySingleStemmedIndexOnly')
