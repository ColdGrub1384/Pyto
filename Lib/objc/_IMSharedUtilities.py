...
IMKeyValueCollectionUserDefaultsStorage = _Class('IMKeyValueCollectionUserDefaultsStorage')
...
IMDContactStoreChangeHistoryEventsHandler = _Class('IMDContactStoreChangeHistoryEventsHandler')
...
IMContactStoreChangeHistoryEventsHandler = _Class('IMContactStoreChangeHistoryEventsHandler')
...
IMSharedUtilitiesProtoCloudKitEncryptedParticipantChange = _Class('IMSharedUtilitiesProtoCloudKitEncryptedParticipantChange')
