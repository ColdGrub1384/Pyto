...
SignpostSupportMachTimeTranslationRange = _Class('SignpostSupportMachTimeTranslationRange')
SignpostSupportSerializabledObjectCollection = _Class('SignpostSupportSerializabledObjectCollection')
...
SignpostSupportExactProcessNameWhitelist = _Class('SignpostSupportExactProcessNameWhitelist')
SignpostSupportExactProcessNameBlacklist = _Class('SignpostSupportExactProcessNameBlacklist')
...
SignpostSupportSubsystemCategoryFilter = _Class('SignpostSupportSubsystemCategoryFilter')
SignpostSupportSubsystemCategoryBlacklist = _Class('SignpostSupportSubsystemCategoryBlacklist')
SignpostSupportSubsystemCategoryWhitelist = _Class('SignpostSupportSubsystemCategoryWhitelist')
SignpostSupportSubsystemCategoryFilterEntry = _Class('SignpostSupportSubsystemCategoryFilterEntry')
