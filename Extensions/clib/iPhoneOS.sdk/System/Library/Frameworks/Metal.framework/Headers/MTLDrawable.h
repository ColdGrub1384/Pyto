 ...
 */
- (void)presentAfterMinimumDuration:(CFTimeInterval)duration API_AVAILABLE(ios(10.3)) API_UNAVAILABLE(macos, macCatalyst);

/*!
 @method addPresentedHandler
 @abstract Add a block to be called when this drawable is presented on screen.
 */
- (void)addPresentedHandler:(MTLDrawablePresentedHandler)block API_AVAILABLE(ios(10.3)) API_UNAVAILABLE(macos, macCatalyst);
 ...
 */
@property(nonatomic, readonly) CFTimeInterval presentedTime API_AVAILABLE(ios(10.3)) API_UNAVAILABLE(macos, macCatalyst);
...
*/
@property (nonatomic, readonly) NSUInteger drawableID API_AVAILABLE(ios(10.3)) API_UNAVAILABLE(macos, macCatalyst);
