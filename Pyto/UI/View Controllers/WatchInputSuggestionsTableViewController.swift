...
class WatchInputSuggestionsTableViewController: UITableViewController {
    ...
    @IBAction func addSuggestion(_ sender: Any) {
        let alert = UIAlertController(title: NSLocalizedString("watchInputSuggestions.title", comment: "The title of the alert for adding a new suggestion"), message: NSLocalizedString("watchInputSuggestions.message", comment: "The message of the alert for adding a new suggestion"), preferredStyle: .alert)
        alert.addTextField(configurationHandler: nil)
        alert.addAction(UIAlertAction(title: NSLocalizedString("cancel", comment: "'Cancel' button"), style: .cancel, handler: nil))
        
        alert.addAction(UIAlertAction(title: NSLocalizedString("add", comment: "Add"), style: .default, handler: { (_) in
